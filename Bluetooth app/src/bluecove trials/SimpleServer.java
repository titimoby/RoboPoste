 ...
 *  under the License.
 *
 *  @version $Id: SimpleServer.java 2471 2008-12-01 03:44:20Z skarzhevskyy $
 */ 
...
public class SimpleServer {
	...
	public SimpleServer(String name) throws BluetoothStateException, InterruptedException {
	...
	public boolean run(String name) throws InterruptedException {
		try {
